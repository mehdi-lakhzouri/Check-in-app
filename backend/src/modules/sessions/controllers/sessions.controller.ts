...
import { CreateSessionDto, UpdateSessionDto, SessionFilterDto, AssignParticipantsDto, BulkCreateSessionsDto } from '../dto';
...
export class SessionsController {
  ...
  @ApiResponse({ 
    ...
    schema: {
      properties: {
        ...
        message: { type: 'string', example: 'Bulk create completed: 5 created, 1 failed' },
        data: {
          type: 'object',
          properties: {
  ...
  @ApiParam({ name: 'id', description: 'Session ID', example: '507f1f77bcf86cd799439011' })
  @ApiResponse({ status: 200, description: 'Session participants retrieved successfully' })
  @ApiResponse({ status: 404, description: 'Session not found' })
  ...
  @ApiParam({ name: 'id', description: 'Session ID', example: '507f1f77bcf86cd799439011' })
  @ApiResponse({ status: 200, description: 'Session check-ins retrieved successfully' })
  @ApiResponse({ status: 404, description: 'Session not found' })
