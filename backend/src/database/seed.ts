...
const ORGANIZATIONS = [
  'MIT', 'Stanford University', 'Harvard Medical School', 'Oxford University',
  'Cambridge University', 'Yale Institute', 'Princeton University', 'UC Berkeley',
  'Caltech', 'Columbia University', 'Duke University', 'Johns Hopkins University',
  'UCLA', 'University of Tokyo', 'ETH Zurich', 'Imperial College London',
  'CERN', 'Max Planck Institute', 'Tsinghua University', 'NIH',
  'Google Research', 'Microsoft Research', 'Meta AI', 'OpenAI',
  'DeepMind', 'IBM Research', 'Apple AI', 'Amazon Science',
  'NVIDIA Research', 'Intel Labs', 'Tesla AI', 'Anthropic',
  'NASA JPL', 'ESA', 'SpaceX', 'Blue Origin',
  'WHO', 'UNESCO', 'World Bank', 'IMF',
  ...
  'ESPRIT', 'INSAT', 'ENIT', 'FST', 'ENSI', 'ISI', 'IHEC',
  'University of Tunis', 'University of Sfax', 'University of Sousse',
];
...
const FIRST_NAMES = [
  ...
  'Mohamed', 'Ahmed', 'Fatima', 'Youssef', 'Mariam', 'Ali', 'Sara', 'Omar',
  'Nour', 'Khalid', 'Salma', 'Hassan', 'Yasmine', 'Karim', 'Amira', 'Rami',
  'Wei', 'Mei', 'Hiroshi', 'Yuki', 'Jin', 'Min', 'Raj', 'Priya', 'Arjun', 'Ananya',
  'Pierre', 'Marie', 'Jean', 'Sophie', 'Hans', 'Anna', 'Carlos', 'Maria',
  'Giovanni', 'Giulia', 'Dmitri', 'Anastasia', 'Olga', 'Ivan', 'Elena', 'Viktor',
];
...
const LAST_NAMES = [
  ...
  'Ben Ali', 'Trabelsi', 'Bouazizi', 'Mejri', 'Chaabane', 'Lahmar', 'Gharbi',
  'Wang', 'Li', 'Zhang', 'Chen', 'Liu', 'Tanaka', 'Suzuki', 'Yamamoto',
  'Kumar', 'Sharma', 'Patel', 'Singh', 'Gupta', 'Verma', 'Joshi', 'Reddy',
...
const SESSION_TEMPLATES = [
  ...
  { name: 'Opening Ceremony & Welcome Address', location: 'Grand Auditorium', capacity: 500, day: 1 },
  { name: 'Keynote: The Future of AI in Healthcare', location: 'Grand Auditorium', capacity: 500, day: 1 },
  { name: 'Workshop: Machine Learning Fundamentals', location: 'Workshop Hall A', capacity: 80, day: 1 },
  { name: 'Workshop: Deep Learning with PyTorch', location: 'Workshop Hall B', capacity: 80, day: 1 },
  { name: 'Panel: Ethics in AI Research', location: 'Conference Room 1', capacity: 150, day: 1 },
  { name: 'Networking Lunch & Poster Session', location: 'Exhibition Hall', capacity: 300, day: 1 },
  { name: 'Technical Talk: Transformer Architectures', location: 'Lecture Hall 1', capacity: 200, day: 1 },
  { name: 'Hands-on Lab: NLP Applications', location: 'Computer Lab 1', capacity: 50, day: 1 },
  
  // Day 2 - Advanced Topics
  { name: 'Keynote: Quantum Computing Breakthroughs', location: 'Grand Auditorium', capacity: 500, day: 2 },
  { name: 'Workshop: Reinforcement Learning', location: 'Workshop Hall A', capacity: 80, day: 2 },
  { name: 'Workshop: Computer Vision Techniques', location: 'Workshop Hall B', capacity: 80, day: 2 },
  { name: 'Panel: Industry vs Academia', location: 'Conference Room 1', capacity: 150, day: 2 },
  { name: 'Research Presentations: Session A', location: 'Lecture Hall 1', capacity: 200, day: 2 },
  { name: 'Research Presentations: Session B', location: 'Lecture Hall 2', capacity: 200, day: 2 },
  { name: 'Startup Pitch Competition', location: 'Innovation Stage', capacity: 250, day: 2 },
  { name: 'Evening Social & Awards', location: 'Rooftop Terrace', capacity: 300, day: 2 },
  
  // Day 3 - Specializations
  { name: 'Keynote: Sustainable Technology', location: 'Grand Auditorium', capacity: 500, day: 3 },
  { name: 'Workshop: MLOps Best Practices', location: 'Workshop Hall A', capacity: 80, day: 3 },
  { name: 'Workshop: Data Engineering at Scale', location: 'Workshop Hall B', capacity: 80, day: 3 },
  { name: 'Roundtable: Research Funding Strategies', location: 'Executive Suite', capacity: 40, day: 3 },
  { name: 'Demo Session: Latest Tools & Frameworks', location: 'Exhibition Hall', capacity: 300, day: 3 },
  { name: 'Career Fair & Recruiting', location: 'Main Lobby', capacity: 400, day: 3 },
  { name: 'Technical Talk: Edge AI & IoT', location: 'Lecture Hall 1', capacity: 200, day: 3 },
  { name: 'Hackathon Kickoff', location: 'Innovation Lab', capacity: 100, day: 3 },
  
  // Day 4 - Closing & Future
  { name: 'Hackathon Presentations', location: 'Innovation Stage', capacity: 250, day: 4 },
  { name: 'Panel: Future of Work in Tech', location: 'Conference Room 1', capacity: 150, day: 4 },
  { name: 'Workshop: Leadership in Tech', location: 'Workshop Hall A', capacity: 80, day: 4 },
  { name: 'Closing Keynote: Vision 2030', location: 'Grand Auditorium', capacity: 500, day: 4 },
  { name: 'Award Ceremony & Recognition', location: 'Grand Auditorium', capacity: 500, day: 4 },
  { name: 'Farewell Reception', location: 'Garden Pavilion', capacity: 350, day: 4 },
];
...
function generateEmail(firstName: string, lastName: string, index: number): string {
  const domains = ['gmail.com', 'outlook.com', 'university.edu', 'research.org', 'company.com', 'yahoo.com', 'proton.me'];
...
class Seeder {
  ...
  async seedParticipants(): Promise<any[]> {
    ...
    let referralIndex = 0;
    for (let i = 0; i < ambassadors.length && referralIndex < regularParticipants.length; i++) {
      ...
      if (numReferrals > 0 && referralIndex + numReferrals <= regularParticipants.length) {
    ...
    console.log(`   - 60 Travel Grant Applicants (20 pending, 25 approved, 15 rejected)`);
  ...
  async seedSessions(): Promise<any[]> {
    ...
    const sessions: any[] = SESSION_TEMPLATES.map((template, index) => {
      ...
      const duration = template.name.includes('Workshop') ? 2 : 
                       template.name.includes('Keynote') ? 1.5 : 
                       template.name.includes('Reception') ? 3 : 1;
      ...
      return {
        ...
        requiresRegistration: template.name.includes('Workshop') || template.name.includes('Hackathon'),
        checkInsCount: 0,
        day: template.day,
      };
    });
  ...
  async seedRegistrations(
    ...
    for (const participant of activeParticipants) {
      ...
      for (const session of selectedSessions) {
        ...
        registrations.push({
          ...
          status,
          notes: status === RegistrationStatus.CANCELLED ? 'Schedule conflict' : undefined,
        });
      }
    }
    ...
    const confirmed = createdRegistrations.filter(r => r.status === RegistrationStatus.CONFIRMED).length;
    const pending = createdRegistrations.filter(r => r.status === RegistrationStatus.PENDING).length;
    const cancelled = createdRegistrations.filter(r => r.status === RegistrationStatus.CANCELLED).length;
  ...
  async seedCheckIns(
    ...
    for (const session of openSessions) {
      ...
      const checkingInRegistrations = randomElements(sessionRegistrations, numCheckIns);
      ...
      for (const registration of checkingInRegistrations) {
        ...
        const method = Math.random() > 0.3 ? CheckInMethod.QR : CheckInMethod.MANUAL;
        ...
        checkIns.push({
          ...
          method,
          checkedInBy: method === CheckInMethod.MANUAL ? 'Staff Member' : undefined,
          isLate,
    ...
    const qrCount = createdCheckIns.filter(c => c.method === CheckInMethod.QR).length;
    const manualCount = createdCheckIns.filter(c => c.method === CheckInMethod.MANUAL).length;
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      const registrations = await this.seedRegistrations(participants, sessions);
      ...
      leaderboard.forEach((amb: any, idx) => {
        console.log(`   ${idx + 1}. ${amb.name} - ${amb.ambassadorPoints} pts (${amb.referredParticipantIds.length} referrals)`);
      });
      ...
      console.log('\n📅 Session Status:');
      const openSessions = await this.sessionModel.countDocuments({ isOpen: true });
      const closedSessions = await this.sessionModel.countDocuments({ isOpen: false });
